...
const RopaMujer = () => {
  ...
  const productosFiltrados = ropaMujer.filter(
    (p) =>
      (!descripcion ||
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh", flexDirection: "column" }}>
      <Helmet>
        <title>Ropa de Mujer - Tienda Online</title>
        <meta
          name="description"
          content="Ropa de mujer en la tienda online. Filtra por precio y descripción."
        />
      </Helmet>
      <CssBaseline />
      <AppHeader />
