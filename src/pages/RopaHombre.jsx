...
const RopaHombre = () => {
  ...
  const productosFiltrados = ropaHombre.filter(
    (p) =>
      (!descripcion ||
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh", flexDirection: "column" }}>
      <Helmet>
        <title>Ropa de Hombre - Tienda Online</title>
        <meta
          name="description"
          content="Ropa de hombre en la tienda online. Filtra por precio y descripción."
        />
      </Helmet>
      <CssBaseline />
      <AppHeader />
